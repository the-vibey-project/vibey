...
> **Codex skill mirror** of `.claude/skills/claudeloop-architecture/SKILL.md`. When this guidance changes, update Claude skill, Cursor rule, and `.agents/skills/` in the same PR.
