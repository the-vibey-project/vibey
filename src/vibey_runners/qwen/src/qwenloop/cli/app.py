...
"""The command line of this runner package's two engines (ADR-0061).
...
def main() -> None:
    """`qwenloop`: this runner on a Qwen model (ADR-0061)."""
    _run_as(QWENLOOP)


def gptoss_main() -> None:
    """`gptossloop`: this runner on GPT-OSS, the sovereign default engine (ADR-0061)."""
    _run_as(GPTOSSLOOP)
