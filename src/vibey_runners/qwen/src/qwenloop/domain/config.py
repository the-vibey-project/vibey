...
#: The Qwen model `qwenloop` asks an endpoint for (ADR-0062): Qwen3 14B, under the name
...
class RunnerIdentity:
    """Which engine this process runs as (ADR-0062).
...
class QwenConfigParser:
    ...
    def __init__(self, *, default_model: str = DEFAULT_ENDPOINT_MODEL) -> None:
        # The model a mapping that names none is given: each engine's own (ADR-0062).
