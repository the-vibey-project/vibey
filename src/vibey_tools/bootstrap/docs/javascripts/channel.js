// GENERATED by scripts/design/generate.py from design/web/channel.js. Do not edit: change the tokens and run `python3 scripts/design/generate.py`. tests/meta/test_design_tokens_generated.py fails on drift.
(() => {
  "use strict";
