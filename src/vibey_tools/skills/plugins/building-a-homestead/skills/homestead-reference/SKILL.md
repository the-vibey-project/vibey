...
| **GDD (Growing Degree Days)** | Heat accumulation used to predict crop development. Calculated as (daily max + daily min)/2 - base temperature. More reliable than calendar dates for timing planting and harvest. | §17 → `homestead-crops-rotation-pests-and-water` |
