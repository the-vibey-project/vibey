...
This is a **Claude Code plugin marketplace**: 131 plugins composed of 672 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 672 skills land.
