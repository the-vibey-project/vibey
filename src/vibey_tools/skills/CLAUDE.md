...
This is a **Claude Code plugin marketplace**: 130 plugins composed of 665 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 665 skills land.
