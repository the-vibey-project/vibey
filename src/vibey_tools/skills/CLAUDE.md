...
This is a **Claude Code plugin marketplace**: 132 plugins composed of 680 Agent Skills,
...
2. **Verify** — installs that exact version from TestPyPI and asserts all 680 skills land.
