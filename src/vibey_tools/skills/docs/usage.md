...
```bash
vibey-skills install --all                        # all 680 skills
...
vibey-skills: copied 680 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 680 skill(s) already present, skipped: agile-delivery, ...
