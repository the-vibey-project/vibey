...
```bash
vibey-skills install --all                        # all 710 skills
...
vibey-skills: copied 710 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 710 skill(s) already present, skipped: agile-delivery, ...
