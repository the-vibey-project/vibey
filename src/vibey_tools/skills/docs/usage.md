...
```bash
vibey-skills install --all                        # all 698 skills
...
vibey-skills: copied 698 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 698 skill(s) already present, skipped: agile-delivery, ...
