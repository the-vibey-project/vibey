...
```bash
vibey-skills install --all                        # all 688 skills
...
vibey-skills: copied 688 skill(s) into /Users/you/.claude/skills

$ vibey-skills install --all
vibey-skills: 688 skill(s) already present, skipped: agile-delivery, ...
