...
import { CatalogueParser } from '../../src/core/catalogue';
import { EngineCommand } from '../../src/core/engine-command';
import type { BudgetBreach, BudgetGuardInterface, SpendEntry, SpendLedgerInterface, SpendTotals } from '../../src/core/interfaces/budgets-interface';
import type { CatalogueEngine, Effort, LoopSelectorInterface, Selection, SelectionRequest } from '../../src/core/interfaces/catalogue-interface';
import type { ChangedFile, CommitOutcome, GitClientInterface, MergeOutcome } from '../../src/core/interfaces/git-interface';
import type { LockAttempt, LockOwner, ModelSlotLockInterface } from '../../src/core/interfaces/model-lock-interface';
import type { RunItem, RunPatch } from '../../src/core/interfaces/run-events-interface';
import type { RunHistoryEntry, RunHistoryInterface, RunRecord, RunRequest, RunServices, RunStatus } from '../../src/core/interfaces/run-interface';
import type { ResolvedSettings } from '../../src/core/interfaces/settings-interface';
...
describe('TaskRun', () => {
  ...
  it('binds qwenloop through its own QWENLOOP_* settings and config, and hands it a model only when one is named (ADR-0061)', async () => {
    const asked: string[] = [];
