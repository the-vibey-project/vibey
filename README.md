...
The same tree is a Claude Code plugin marketplace — every plugin in the family, the 130
...
| [Decision records](docs/architecture/decisions/) | Why each hard call was made (36 ADRs) |
