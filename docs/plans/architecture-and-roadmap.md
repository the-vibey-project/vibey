...
> [ADR-0061](../architecture/decisions/0061-gptossloop-is-the-sovereign-engine.md) that local
...
[ADR-0061](../architecture/decisions/0061-gptossloop-is-the-sovereign-engine.md). When this document was written
...
([ADR-0061](../architecture/decisions/0061-gptossloop-is-the-sovereign-engine.md)). When enabled they are
...
[engines]
enabled = ["claudeloop", "codexloop", "cursorloop", "agyloop"]   # gptossloop
                                 # (the sovereign default) is always added;
