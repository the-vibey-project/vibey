...
**Status:** accepted; superseded in part by ADR-0067 (the package is `vibey-engine`, not `vibey`) · **Date:** 2026-09-18 · **Supersedes in part:** ADR-0021, ADR-0019, ADR-0034, ADR-0015 · **Implementation corrected:** #259 (2026-09-18: decision 5's `pin_version` had stopped pinning adopters; it now pins the installed `vibey` release that `vibey-gh` runs from)
